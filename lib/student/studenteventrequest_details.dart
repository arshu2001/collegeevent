...
class StudentevreqDetails extends StatefulWidget {
  const StudentevreqDetails({super.key});

  @override
  State<StudentevreqDetails> createState() => _StudentevreqDetailsState();
}

class _StudentevreqDetailsState extends State<StudentevreqDetails> {
  ...
  Future<void>studenteventrequesr()async{
